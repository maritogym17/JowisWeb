  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      ...
      <header className="mx-auto flex max-w-[1400px] items-center justify-between px-6 pt-8 pb-4 md:px-12">
        ...
        <nav className="hidden gap-8 font-mono text-[11px] uppercase tracking-[0.2em] text-muted-foreground md:flex">
          <Link to="/carta" className="hover:text-foreground">Carta completa</Link>
          <a href="#resenas" className="hover:text-foreground">Reseñas</a>
          <a href="#visita" className="hover:text-foreground">Visita</a>
        </nav>
            ...
            <ol className="rule-t">
              {menu.map((item, i) => (
                ...
                >
                  ...
                  <span className="col-span-6 text-right font-display text-2xl md:col-span-1 md:text-3xl">
                    {item.price}
                  </span>
                </li>
              ))}
